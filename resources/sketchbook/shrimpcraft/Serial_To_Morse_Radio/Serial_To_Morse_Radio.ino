/*
Compiled from a trawl of forums like 
...
insert a wire to pin D8 (A16 on Shrimp instructions) to broadcast on 
FM/AM. Actually writes HIGH and LOW on ALL outputs
flashes LEDS on D13-D12 with morse save message, or if receiving serial, the inputted alphanumeric text
...
//uncomment below to change message speed
...
// decode alphanumeric input string to morse
String morseCode[] = { 
    ".-", // A
    "-...", // B
    "-.-.", // C
